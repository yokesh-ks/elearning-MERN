 ...
 return(
    <div class="create">
        <form>
            <h1>Create Course</h1>
            <label>Title</label>
            <input type="text" onChange={handleChange} Placeholder="Enter the Title" name="title" value={video.title}></input>
            <label>Description</label>
            <textarea type="text" onChange={handleChange} Placeholder="Enter brief Description" name="description" value={video.description}></textarea>
            <button onClick={publish} className="publish-button">Publish</button>    
        </form>
        <div className="youtube-link">
            <form onSubmit={handleYoutubeSubmit}>
                <input type="text" Placeholder="Enter Youtube Url"  required
                onChange={handleYoutubeChange} ></input>
